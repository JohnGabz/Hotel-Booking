<div id="error-modal" class="fixed inset-0 z-[80] hidden items-center justify-center px-4" aria-hidden="true" role="dialog" aria-modal="true">
    <div class="absolute inset-0 bg-stone-950/45" data-error-modal-close></div>
    <section class="relative w-full max-w-lg rounded-2xl border border-stone-200 bg-white p-5 shadow-2xl sm:p-6">
