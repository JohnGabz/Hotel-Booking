<div id="error-modal" class="fixed inset-0 z-[80] hidden overflow-y-auto items-end justify-center px-0 sm:items-center sm:px-4" hidden aria-hidden="true" role="alertdialog" aria-modal="true" aria-labelledby="error-modal-title" aria-describedby="error-modal-message" tabindex="-1">
    <div class="absolute inset-0 bg-stone-950/45" data-error-modal-close></div>
    <section class="modal-panel max-w-lg p-5 sm:p-6 mt-auto sm:my-auto relative z-10">
