            ...
            <div class="hidden items-center gap-3 lg:flex">
                @auth
                    ...
                    <div class="relative">
                        ...
                        <div id="notif-menu" class="hidden absolute right-0 mt-2 w-80 rounded-xl bg-white border border-stone-200 shadow-lg py-2 z-50">
