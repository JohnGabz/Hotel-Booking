        ...
        <div class="max-w-2xl mx-auto">
            <div class="card">
                <div class="mb-8 text-center">
                    <p class="text-sm uppercase tracking-[0.3em] text-brand-primary">Welcome back</p>
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between gap-4 text-sm">
                        ...
                        <a href="{{ route('password.request') }}" class="font-semibold text-brand-primary">Forgot password?</a>
                    </div>
                    <button type="submit" class="btn-primary w-full">Login</button>
                </form>
                <p class="mt-6 text-center text-sm text-slate-600">New here? <a href="{{ route('register') }}" class="font-semibold text-brand-primary">Create an account</a></p>
            </div>
        </div>
    </div>
</section>
